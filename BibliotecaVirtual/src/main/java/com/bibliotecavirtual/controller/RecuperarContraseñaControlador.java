...
public class RecuperarContraseñaControlador {
    ...
    @FXML
    private void handleEnviarCodigo() throws Exception {
    ...
    @FXML
    private void handleConfirmarCambio(){
        ...
        boolean usuario_actualizado = new UsuarioService().actualizarContraseña(txtCorreo.getText().trim(), nueva_contraseña);
